    ...
    <section className="mb-32 text-gray-800">
      <div className="flex flex-wrap">
        <div className="grow-0 shrink-0 basis-auto w-full md:w-2/12 lg:w-3/12">
          <img
            src="https://foodtank.com/wp-content/uploads/2023/02/Turkey-Syria-earthquakes-emergency-food-assistance-World-Central-Kitchen.jpg"
        ...
        <div className="grow-0 shrink-0 basis-auto w-full md:w-10/12 lg:w-9/12 md:pl-6 text-center md:text-left">
          <h5 className="text-xl font-semibold mb-6">Turkey</h5>
